...
def render(path=None, view_node=None):
    write = False
    if path is not None:
    ...
    if view_node is not None:
        return bpy.data.images['Viewer Node'].pixels


def set_ros_path():
    sys.path.append('/opt/ros/melodic/lib/python2.7/dist-packages')
    sys.path.append('/home/nolan/miniconda3/envs/py2/lib/python2.7/site-packages')
...
def test():
    ...
    img = render(path='/home/nolan/Desktop/RenderForCar/module/test.jpg')
...
import sys
sys.path.append('/home/showay/Desktop/RenderForCar/module')
